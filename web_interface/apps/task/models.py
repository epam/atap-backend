...
class Report(models.Model):
    ...
    STATUS_CHOICES = ((SUCCESS, "SUCCESS"), (QUEUED, "QUEUED"), (GENERATING, "GENERATING"))

    status = models.CharField(choices=STATUS_CHOICES, max_length=20)
    task = models.ForeignKey(Task, on_delete=models.CASCADE, related_name="reports")
    delta_starting_task = models.ForeignKey(
        Task, on_delete=models.CASCADE, null=True, blank=True, related_name="reports_starting_from"
    )
